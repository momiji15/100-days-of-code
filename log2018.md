...
**Thoughts**
A continuation of "You fix one problem and another one arises." I realized how to get rid of the numbers, however I can only do it if I display all the variables! Apparently there are some people in the digilab at school who know a thing or ten about R or programming in general, so I will pick their brains before I post my issue on a message board.
